...
In this appendix, we briefly report the implementation of the main function used during the simulations in Chapter \ref{chap:experiments} in MATLAB\textsuperscript{\textregistered}.

The full code is available at the following \href{https://github.com/fofe1125/tesi}{link}\footnote{https://github.com/fofe1125/tesi}. Here we report the main functions and implementation details.
