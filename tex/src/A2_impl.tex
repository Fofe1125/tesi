...
In this appendix, we breifly report the implementation of the main function used during the simulations in Chapter \ref{chap:experiments} in MATLAB\textsuperscript{\textregistered}.
